const errors = {
  BAD_REQUEST: {error: 'Bad request', msg: 'The request could not be understood by the server due to malformed syntax.',
      code: 400},
  ...
  INTERNAL_SERVER_ERROR: {error: 'Internal server error', msg: 'The server encountered an unexpected condition',
      code: 500},
  BAD_GATEWAY: {error: 'Bad gateway', msg: 'While acting as a gateway or proxy, received an invalid response from the' +
          'upstream server', code: 502},
  SERVICE_UNAVAILABLE: {error: 'Service Unavailable', msg: 'The server is currently unavailable', code: 503},
  GATEWAY_TIMEOUT: {error: 'Gateway Timeout', msg: 'While acting as a gateway or proxy, did not receive a timely' +
